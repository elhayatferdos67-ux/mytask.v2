...
from agent.tools.enhanced_web_dev_tool import EnhancedWebDevTool
...
class ToolManager:
    ...
    def _register_sandbox_tools(self, disabled_tools: List[str]):
        ...
        sandbox_tools = [
            ...
            ('enhanced_web_dev_tool', EnhancedWebDevTool, {'project_id': self.project_id, 'thread_id': self.thread_id, 'thread_manager': self.thread_manager}),
        ]
